namespace Recipes.Models.BlogContents
{
    public static class BlogPostsProgramming
    {
        ...
        public const string content_03102012_b = "<p>When I have a long list on a web page, I would like to give the user an option to hide it. Turns out that is simple to do with a little bit of <b>jQuery</b>. All the contents that I would like to hide or show would go into a div element. Next to it, I will add a link to toggle the hide/show behaviour. Here's how it looks in my code:</p><pre class=\"brush: xml\">" +
        ...
        public const string content_12082012_r = "<p>Let's assume there is a folder called <b>Bob's Documents</b> where only Bob, and not even the <b>Admin</b>, should have access.</p><ol><li>Right-click on <b>Bob's Documents</b> and select <b>Properties</b></li>" +
            ...
            "<p align=\"center\">Select Bob's Documents <b>Properties</b></p><li><b>Bob's Documents Properties</b> window will open. Switch to <b>Security</b> tab and click <b>Advanced</b> button.</li>" +
            ...
            + "<p align=\"center\">Bob's Documents Properties</p><li><b>Advanced Security Settings for Bob's Documents</b> will open. On the <b>Permissions</b> tab, Click <b>Change Permissions</b> button.</li>" +
            ...
            + "<p align=\"center\">Advanced Security Settings for Bob's Documents - but not the same one!</p><li>As soon as the chechbox is unticked, a warning called <b>Windows Security</b> will pop up. Since we're getting rid of parent permissions, click <b>Remove</b>.</li>" +
            ...
            "<p align=\"center\"><b>Windows Security</b> warning</p><li>All permissions should have disappeared from the <b>Permission entries</b>. Now click <b>Add</b>.</li><li><b>Select User or Group</b> window will open. In <b>Enter the object name to select</b>, type Bob and click <b>Check Names</b> to make sure there is no typo. "
            ...
            "<p align=\"center\">Select User or Group</p><li>Click <b>OK</b>. Now the <b>Permissions Entry for Bob's Documents</b> window will pop up. Let's give Bob full control - click the checkbox across from <b>Full Control</b> under <b>Allow</b>. All other checkboxes under <b>Allow</b> will select automatically. Click <b>OK</b> to close this window.</li>" +
            ...
            "<p align=\"center\">Permissions Entry for Bob's Documents</p><li>About done. Click <b>OK</b> in <b>Advanced Security Settings for Bob's Documents</b> to close it, and in another <b>Advanced Security Settings for Bob's Documents</b> to close it too, and <b>OK</b> in <b>Bob's Documents Properties</b>.</li><li>Try to browse to <b>Bob's Documents</b>. Even if you're on <b>Administrator</b> account, you should not be able to, but you should if you are logged in as Bob.</li>" +
            ...
            "<p align=\"center\">Permissions are set</p></ol><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_08112012_r = "<p>The plan is to have a list of symbols (configurable), to get the data from yahoo and dynamically load the data into the <b>WebGrid</b> control. Therefore, I started with the basic <b></b>ViewModel that has two sets of entities - one for the symbols and one for the data itself. Eventually the list of symbols will be made configurable.</p><pre class=\"brush: csharp\">" +
            ...
            <B>  </B> </TD><TD></TD></TABLE>" + "<br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_25102012_r = "<p>Create an instance of the <b>WebBrowser</b> and subscribe to <b>Navigated</b> and <b>DocumentCompleted</b> events</p><pre class=\"brush: csharp\">" +
            ...
            }" + "</pre><p></p>Here I actually copy the cookies, but that is not necessary. The <b></b>WebBrowser will keep them internally and use them. The purpose of this code is to check if the browser is redirected to \"my.yahoo.com\", which is the indication of successful login. Further logic may be applied from here. <pre class=\"brush: csharp\">" +
        ...
        public const string content_14102012_r = "<pre class=\"brush: csharp\">" +
            ...
            "<p align=\"center\">Create a New Crystal Report Document</p><p>On the next page, I choose to populate my report from .NET Object in project data. My PingResult class is in the list, and I move it to the <b>Selected Tables</b>.</p>" +
            ...
            "<p align=\"center\">Choose the information to display on the report</p><p>I skip <b>Grouping</b>, <b>Report Selection</b> and <b>Report Style</b>, leaving default values. Now I have my report editor. I only want to do a little change - make the headers human readable, so I edit them in the following manner</p>" +
            ...
            "<p align=\"center\">FileNotFoundException</p><p>which is resolved by adding the <b>useLegacyV2RuntimeActivationPolicy=\"true\"</b> parameter to the startup node of my app.config which now looks like the following</p><pre class=\"brush: xml\">" +
            @"&lt;?xml version='1.0'?&gt;
            &lt;configuration&gt;
        ...
        public const string content_07102012_b = "<p>Today I learned a simple technique to show/hide parts of content on the page. In my sample application, I'm using it to display a part of a long blog post, and then at the end of the part to display a button that will show the rest of the post. The button initially says <b>\"Show more\"</b>. When the button is clicked, it displays the previously hidden part and its text changes to <b>\"Show less\"</b>. So, in essence, it toggles the display state of the div it is connected to, and its own text.</p>";
        public const string content_07102012_r = "<p>Additionally, I'm displaying posts dynamically, so for each post there is a div with the first part of the post, the div with the rest, and the toggle button. Here's how it works:</p><p>For each blog post in the model a div is created for the rest of the post, and a button. The ID for both is assigned dynamically using a simple counter.</p><pre class=\"brush: xml\">" + 
           ...
           "</pre><p>The javaScript function <b>toggleDiv()</b> takes two parameters: div ID and button ID. First the function toggles the div display property by using the jQuery function <b>toggle()</b>. Next, based on the div display state, the button text is set to one of the two possible values. And that's it.</p><pre class=\"brush: jscript\">" + 
        ...
        public const string content_27092012_b = "<p>Another way of getting back web search results from Google is to use <b>Google API</b>. I've spent a couple of hours researching the option to do that, and did not find too many exciting choices. There is an option to use Google API which is deprecated, and limits the amount of searches to about 100 per day, and does not return more than 64 results, and does not allow automatic searches, or to use Google Custom Search, which can be used only to create site-specific custom searches. Anyway, as an exercise I decided to implement a call to Google API (deprecated one). There are a few options available.</p>";
        public const string content_27092012_r = "<p>The easiest way to use Google API I found was to use Google API for .NET. After I downloaded and referenced the <b>GoogleSearchAPI.NET20</b> dll, it took me a surprisingly small amount of lines of code to create a quick prototype of querying the Google API</p><pre class=\"brush: csharp\">" + 
            ...
            }" + "</pre>" + "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2012/27092012_results.png\" alt=\"results\" /></div>" + "<p align=\"center\">Search Results</p><p><b>References</b></p><a href=\"http://gapi4net.codeplex.com/\">Google API for .NET</a>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_13092012_r = "<pre class=\"brush: csharp\">" +
            ...
            }" + "</pre><p>and then in the <b>BlogController</b> I would have these methods for creating a new blog:</p><pre class=\"brush: csharp\">" +
        ...
        public const string content_09082012_r = "<pre class=\"brush: csharp\">" +
            ...
            "<p align=\"center\">Custom Error Page</p><p>And the log file is in my <b>App_Data</b> folder</p>" +
        ...
        public const string content_06082012_r = "<p>Next, I wanted to see how the game could be run on the MVC platform. The solution in short: use javaScript <b>setInterval</b> function to load the partial view into the div. Use a method in the controller to generate the partial view.</p><p>Here is how my solution looked:</p><pre class=\"brush: csharp\">" +
                    ...
                    @"public static StringBuilder GameOfLifeTableReplaceCell(int i, int j, string colour, StringBuilder sb)
            {
                ...
                return sb;
            }" + "</pre><p>The rest of the code is omitted because it can be found in my earlier post and used with little or no change.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_05082012_r = "<p>However, I soon discovered that just optimizing my Windows visual effects for best performance does a neat trick. If you don't know, it's under <b>Control Panel &rarr; System &rarr; Advanced System Settings &rarr; Advanced &rarr; Performance &rarr; Settings &rarr; Visual Effects &rarr; Adjust for best performance</b>, as in the screen shot below</p>" +
            ...
            "<p align=\"center\">Allow Windows to determine settings</p><p><b>Reference:</b></p><a href=\"http://stackoverflow.com/questions/4734814/wpf-progressbar-foreground-color\">WPF: Progressbar foreground color</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_31072012_r = "<p><b>PopulateGrid</b> adds 50 rows and columns to a WPF Grid, creating a 50x50 matrix of cell. It then adds a rectangle to each cell so coloring could be applied. <b>RePaintCell</b> changes the background color of the cell at position i,j. <b>InitializeArray</b> just fills a 50x50 array of booleans, each value representing either a live or dead cell. <b>CheckCell</b> checks a single cell to find out if it will be live or dead in the next iteration. <b>FillArray</b> uses <b>CheckCell</b> to analyse the current array and construct the array of the next iteration. <b>DrawArray</b> compares the current and next iterations. If there is difference in the color of the cell at i,j, this cell is painted appropriately, otherwise it is skipped. Finally, <b>AddGlider</b> adds a glider element to the empty array so it was easy to test that the game runs correctly. The full listing is below.</p><p><b>MainWindow.xaml</b></p><pre class=\"brush: xml\">" +
            ...
            }" + "</pre><p><b>Reference</b></p><a href=\"http://en.wikipedia.org/wiki/Conway%27s_Game_of_Life\">Conway's Game of Life</a><div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2012/31072012_Game_of_life.png\" alt=\"Game of life\" /></div>" + "<p align=\"center\">The results are impressive</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_14062012_r = "<pre class=\"brush: csharp\">" +
                    ...
                    @"public string GetValidationError(List&lt;ValidationResult&gt; results)
            {
             ...
             return string.Empty;
            }" + "</pre><p><b>References:</b></p><a href=\"http://johan.driessen.se/posts/testing-dataannotation-based-validation-in-asp.net-mvc\">Testing DataAnnotation-based validation in ASP.NET MVC</a><br/><a href=\"http://stackoverflow.com/questions/1269713/unit-tests-on-mvc-validation\">Unit tests on MVC validation</a><br/><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_15052012_r = "<p><b>Gotcha 1.</b> To actually populate the <b>MultiSelectList</b>. The easy (but not quite straightforward) task was to create the <b></b>MultiSelectList and to populate it with all the ingredients. To do that I added the properties to the <b>Recipe</b> class called <b>AllIngredients</b> and <b>SelectedIngredientIDs</b>. The most basic <b>Recipe</b> class now looks like this:</p><pre class=\"brush: csharp\">" +
            ...
            }" + "</pre><p>In the controller, I populate all ingredients from the database into the <b>AllIngredients</b> and then the IDs of the ingredients of the recipe into the <b>SelectedIngredientIDs</b>.</p><pre class=\"brush: csharp\">" +
        ...
        public const string content_13052012_r =
            ...
            "<p align=\"center\">Add a HomeController</p><p>Inside the <b>HomeController.cs</b>, the <b>Index()</b> method, right-click and select <b>Add View</b>. Leave default values and click <b>Add</b>.</p>" +
            ...
            }" + "</pre><p>Next step was to create the database. Right-click <b>Project</b>, select <b>Add</b> -> <b>Add ASP.NET Folder</b> -> <b>App_Data</b>. The folder will be created. It will already have the correct security access settings.</p>" +
            ...
            public ActionResult Details(int id)
            {
             ...
             return View(recipe);
            }" + "</pre><p>Now I'll right-click within the <b></b>Index method and select <b>Add View</b>, which I will configure as follows:</p>" +
            ...
            "<p align=\"center\">Create the List view</p><p>Now if I run the application as it is and navigate to <b>Recipe</b> (<u>http://localhost/Recipe</u>), I should see the list of recipes.</p>" +
            ...
            "<p align=\"center\">Display the list of ingredients</p><p>Next, I want to see the details. I'll add another view by right-clicking within the <b>Details</b> method of the controller and select <b>Add View</b>, which I will configure in the similar fashion:</p>" +
            ...
            &lt;p&gt;
                @Html.ActionLink('Edit', 'Edit', new { id=Model.RecipeID }) |
                @Html.ActionLink('Back to List', 'Index')
            &lt;/p&gt;" + "</pre><p>Now if I run the application, navigate to <b>Recipe</b> and click <b>Details</b> on any of them (the link will point to <u>http://localhost:49606/Recipe/Details/1</u> or similar), I will see the following page:</p>" +
        ...
        public const string content_02052012_r = "<p>To start with, I downloaded and installed VMware vCenter Converter (aka vConverter Standalone). In my case, Local installation was sufficient. In local mode I can only create and manage conversion tasks from the PC on which I install the converter. The client-server installation allows to create and manage conversion tasks remotely in case you need that.</p>" +
            ...
            "<p align=\"center\">Disable Windows Firewall</p><p>You should also check some other things, such as the Windows version being supported, network access, no other conversion jobs running on the source machine and no VMware Converter installations existing on the source PC. After all that is taken care of, I ran the client application. In the application, I selected <b>Convert machine</b> and filled in the details.</p>" +
            ...
            "<p align=\"center\">Uncheck the hard disk</p><p>Next step was to review the details and press <b>Finish</b>. Everything went well and a job was be added to the list, displaying some details and estimated time to completion. Now all I needed was some patience.</p>" +
            ...
            "<p align=\"center\">Install VMWare tools</p><p>In my case, a message appeared and I did exactly as it advised - on the VM, logged in and ran <b>E:\\setup.exe</b> from the command prompt. The installation started and I followed the prompts until VMWare tools were installed.</p>" +
            "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2012/02052012_Click_on_the_virtual_screen.png\" alt=\"Click on the virtual screen\" /></div><p align=\"center\">VMWare message</p>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_01042012_b = "<p>In some cases it is required to return several values from a C++ function to the QML code. In my case, I call the function that checks the syntax of the Qt script that is passed as a string. The <b>QScriptSyntaxCheckResult</b> class does that check for me. If an error is found inside the script, I want to get back the error message and the line and column where the error was detected. In this case a <b>QVariantMap</b> class is the elegant and effective solution. In my C++ code, I pack the values I want to return into an instance of a <b>QVariantMap</b> class:</p>";
        ...
        "<p align=\"center\">Syntax check result</p><p><b>References:</b></p><a href=\"http://comments.gmane.org/gmane.comp.lib.qt.qml/3031\">Q_INVOKABLE member function: Valid argument types</a><br/><a href=\"http://www.fioniasoftware.dk/blog/?p=142\">Implementing tool tips in QML</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_29032012_b = "<p>As a first practical application of connecting C++ to QML I had to integrate a <b>File Open/Close</b> dialog to be accessed from QML, because QML does not have this kind of control natively. So here are the requirements to the simple task:</p>";
        public const string content_29032012_r = "<ul><li>Open button starts the <b>Open File</b> dialog, which allows the user to select a text file</li><li>When the user selects the file, the contents of this file are loaded into an editable field</li><li>The user can edit the file</li><li>Save button opens the <b>Save File</b> dialog, which allows the user to save the contents of the editable field into a new or existing text file</li></ul><p>The C++ header file will define only two functions, <b>getFileContents</b> will be called when the <b>Open</b> button is clicked, and <b>saveFileContents</b> will be called when the <b>Save</b> button is clicked. Here is the full header file:</p><pre class=\"brush: cpp\">" +
        ...
        "</pre><p>In the main.qml I will implement the <b>onClicked</b> events for <b>Open</b> and <b>Save</b> buttons. Each will only take a single line.</p><pre class=\"brush: cpp\">" +
     ...
     onClicked: {
       ...
       //Qt.quit();
        ...
        public const string content_26032012_r = "<pre class=\"brush: js\">" + 
            ...
            "<br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        "</pre><p>Reference:</p><a href=\"http://stackoverflow.com/questions/6152041/qt-qml-anchors-probleme\">QT QML anchors probleme</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        "</pre><p>References:</p><a href=\"http://qt-project.org/forums/viewthread/5276\">QML drop Down Menu or Menu bar</a><br/><a href=\"http://stackoverflow.com/questions/9634897/qt-qml-dropdown-list-like-in-html\">Qt QML dropdown list like in HTML</a><br/><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        "</pre><p>Another addition is the navigation bar on the top, so the user knows where in the document structure he is currently positioned. The arrows effect is achieved by simply adding some \"help\" images that are toggled and their visibility is changed as required by calling the <b>setVisibility</b> function from outside. Navigation bar itself responds to clicks on the items, bringing the user back to the position in the document structure according to the element being clicked.</p><p>Here's how the improved tree view looks like:</p>" +
        ...
        public const string content_08032012_b = "<p>A custom tab control received a slight update: An <b>isDisabled</b> property was added to the <b>CustomTab</b>. The disabled tab does absolutely nothing - does not respond to mouse clicks or mouse enter and exit events. Its name is displayed in gray. So a couple changes were done to the <b>CustomTab</b> which are summarized below.</p>";
        ...
        public const string content_07032012_r = "<pre class=\"brush: xml\">" + 
            ...
            "</pre><p>Just like in a ListView example, the <b>XmlListModel</b> element will be used to read data from the XML file. The usage of the <b>XmlListModel</b> is not limited to lists - data can be accessed directly. When the <b>XmlListModel</b> element is just created, it has no data. Then, at some point, data is loaded and the <b>onCountChanged</b> event fires. This fact is used to trigger the creation of tabs.</p><pre class=\"brush: js\">" + 
            ...
            "</pre><p>References</p><a href=\"http://qt-project.org/doc/qt-4.8/qdeclarativedynamicobjects.html\">Dynamic Object Management in QML</a><br/><a href=\"http://www.pyside.org/docs/pyside/tutorials/qmladvancedtutorial/samegame2.html\">QML Advanced Tutorial 2 - Populating the Game Canvas</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_06032012_r = "<p>From the design point of view, each tab is a 2x2 <b>Grid</b> element. A rectangular grid covers a rounded rectangle. By making top right or top left elements or both of the grid transparent, I make rounded corners visible, giving the impression of a tab with one or two rounded corners. Top elements of the grid are also used to change the height of the red line by modifying their height.</p><p>The most important function is the <b>applyState()</b>. After tab properties such as <b>isSelected</b> or <b>isHighlighted</b> were assigned, the function makes sure that the tab is visualised correctly.</p><pre class=\"brush: js\">" + 
            ...
            @"function clearState()<br />{<br /> var j=1;<br /> for(j=0;j<= numTabs-1;j++)<br /> {<br />  children[j].isSelected = false;<br />  children[j].state = ""unselected"";<br />  children[j].applyState();<br /> }<br />}" + "</pre><p>The <b>clearState()</b> function just loops through the children of <b>tabRow</b>, which are individual tabs. It clears the <b>isSelected</b> tag and applies the proper <b>state</b> (see below). Then it applies the tab state, essentially resetting it to initial state.</p><pre class=\"brush: js\">" + 
            ...
            "</pre><p>Each tab has a <b>MouseArea</b>, which listens to three events: <b>onClicked</b>, <b>onEntered</b> and <b>onExited</b>. Note the usage of <b>hoverEnabled: true</b>, without which the <b>MouseArea</b> would just ignore the last two events mentioned. When the tab is clicked, all tabs are reset first, and then the clicked tab is set to be selected. When the tab is entered or exited, the <b>isHighlighted</b> attribute is toggled and the changes are applied to the tab - but only is it is not already selected. If it is, the event is ignored since the tab should not change if it is already selected, and the mouse is over it.</p><pre class=\"brush: js\">" + 
        ...
        public const string content_05032012_r = "<pre class=\"brush: js\">" + @"<br />ListModel {<br />     ListElement {<br />         name: ""Joe Bloggs""<br />         number: ""123 1234""<br />     }<br />}" + "</pre><p>That will be a list with just one element. Next, there is the <b>delegate</b>. The delegate defines the way data is displayed. Again, it can be very simple, for example</p><pre class=\"brush: js\">" + 
            @"ListView{<br /> id: listView<br /> <br /> ...<br /><br /> delegate: Text{text: name}<br />}" + "</pre><p>Such delegate will just display some text which is taken from the model.</p><p>To make this post slightly less boring, I will first make the <b>ListView</b> read its model from the xml file. For that purpose, the <b>XmlListModel</b> element is used. I will use this sample XML structure:</p><pre class=\"brush: xml\">" + 
            ...
            "</pre><p>The <b>XMLListModel</b> that reads this file will be defined as follows:</p><pre class=\"brush: js\">" + 
        ...
        public const string content_04032012_r = "<p>To create a simple QML project, I select <b>File -> New File or Project</b> from Qt Creator menu. From Projects I select <b>Qt Quick Project</b> and <b>Qt Quick UI</b> on the right.</p>" + 
            ...
            @"Rectangle{<br /> id: listViewPanel<br /> width: 100<br /> height: 100<br /> x: 0<br /> y: 0<br /> border.color: ""black""<br /> color: ""green""<br /> border.width: 1<br /><br /> Text{<br />  text: ""Left panel""<br /> }<br />}" + "</pre><p>The <b>id</b> is optional, but will be used later to reference the element. Other parameters are self-explanatory.</p><p>Here is the first QML application - just a few rectangles that take up the screen.</p><pre class=\"brush:js\">" + 
            ...
            "<p align=\"center\">First QML Application</p><p>References:</p><a href=\"http://qt.nokia.com/\">Qt - Cross-platform application and UI framework</a><br/><a href=\"http://doc.qt.nokia.com/4.7-snapshot/qml-rectangle.html\">QML Rectangle Element</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_26022012_r = "<p>The web script required 3 files to run: a definition file, a javaScript file which gets the folder details from the AVM store and a ftl (FreeMarker template) file which renders HTML. It is also possible to render output in JSON format (and other formats, I guess) but I did not get there yet. The files are called <b>items.get.desc.xml</b>, <b>items.get.js</b> and <b>items.get.html.ftl</b>.</p><p>I placed these files into the Alfresco \"classes\" path, in the subfolder \"items\" under \"webscripts\". The full path on my PC is</p><p>C:\\Alfresco\\tomcat\\webapps\\alfresco\\WEB-INF\\classes\\alfresco\\extension\\templates\\webscripts\\items</p><p>And the full path to the actual files I'm interested in is</p><p>Y:\\hostingitems\\HEAD\\DATA\\www\\avm_webapps\\ROOT\\items</p><p>where Y is the drive I mapped AVM repository to. \"hostingitems\" is the name of the web project where files were created. Currently I'm getting back all files in the folder, so if I want to sort out only XML files I'll need to additional logic.</p><p><b>items.get.desc.xml</b> is a web script description file. Basically, it tells where the script is located and what it does.</p><pre class=\"brush:xml\">" + 
            ...
            "<p align=\"center\">Web Script Results</p><p>Reference:</p><p><a href=\"http://www.packtpub.com/alfresco-developer-guide/book\">Alfresco Developer Guide</a><p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_23022012_r = "<p>\"A local area network for this type of system may also include features such as but not limited to: an Ethernet element, a token ring element, an arcnet element, a fiber distributed data interface element, an industry specification protocol, a bluetooth-based element <u>(named but not contemporary to King Harald Bluetooth of Denmark in the mid-tenth century!)</u>, a telecommunications industry specification\" ...</p>" + 
            "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2012/23022012_Amusing.png\" alt=\"Amusing\" /></div><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        "<p align=\"center\">No Modified Items</p><p>Log off and log on as the Content Contributor. Navigate to the same project and verify that the “Web Forms” section is present in the sandbox and the user can add and modify content.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_12022012_r = "<p>Here is one way to assign a Simple Workflow to the Web Form, if it is associated with a Web Project.</p><p>Navigate to Company Home -> Web Projects, select the web project and choose Actions -> Edit Web Project Settings in the top right part of the screen. Select \"Next\" until you get to the \"Configure Web Forms\" screen. If the web form does not have a workflow associated with it, a small exclamation mark will be displayed.</p>" + 
            ...
            "<p align=\"center\">Recent Snapshots</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_09012012_r = "<p>Below is my take on a complete instruction for migrating a project from Visual SourceSafe to TFS 2010, using Visual Studio 2010, that I prepared for other developers.</p><p style=\"font-size:5;font-weight:bold\">1. Before you begin</p><p style=\"font-size:4;font-weight:bold\">1.1. Machine configuration</p><p><ul><li>Install Visual Studio on the machine that will perform the migration</li><li>Install Visual SourceSafe 2005</li><li>Install the <a href=\"http://archive.msdn.microsoft.com/KB950185/Release/ProjectReleases.aspx?ReleaseId=1123\">update that is associated with article 950185 in Microsoft Knowledge Base</a></li><li>Make sure you know the SourceSafe database admin password</li></ul></p><p style=\"font-size:4;font-weight:bold\">1.2. Permissions</p><p><ul><li>Know the Admin password to the Visual SourceSafe database</li><li>Be an Administrator of your PC</li><li>Be a member of TFS Server Administrators or Collection Administrators</li></ul></p><p style=\"font-size:5;font-weight:bold\">2. Backup and restore SourceSafe project</p><p style=\"font-size:4;font-weight:bold\">2.1. Backup SourceSafe project</p><p style=\"font-size:3;font-style:italic;font-weight:bold\">2.1.1. Use the command line tool</p><p>For this example, the \\Server\\VSS\\database\\VSS-DB SourceSafe database and $/MyRoot/MyProject projects were used.</p><p>The backup and restore tools, ssarc and ssrestor are located in the SourceSafe folder, usually C:\\Program Files\\Microsoft Visual SourceSafe. From the command prompt, navigate to that folder and run the command</p><p><b>ssarc -d- -i -yadmin,password -s\\Server\\VSS\\database\\VSS-DB CodeProject.ssa \"$/MyRoot/MyProject\"</b> (replace password with SourceSafe admin password, and specify the desired SourceSafe database location and backup database name).</p><p>If the warning \"For reliability and performance reasons using the analyze, archive and restore utilities over network is not recommended. Do you want to continue? (Y/N)\", select Y.</p><p>The command will create a backup database CodeProject.ssa in the Visual SourceSafe folder.</p><p style=\"font-size:3;font-style:italic;font-weight:bold\">2.1.2. Use the Visual SourceSafe Administration UI</p><ul><li>Run Start &rarr; Programs &rarr; Microsoft Visual SourceSafe &rarr; Microsoft Visual SourceSafe Administration</li><li>Select Archive &rarr; Archive Projects from menu</li><li>Select a project to back up</li><li>Select \"Next\"</li><li>Select \"Save Data to File\", point to the location of the file</li><li>Select \"Next\"</li><li>Select \"Archive all of the data\"</li><li>Select \"Finish\"</li><li>The message box \"Archive/restore successfully completed\" will appear</li></ul>" + 
            ...
            "<a href=\"http://1.bp.blogspot.com/-4goEc0y09kA/TwuVU2WQ1DI/AAAAAAAAAio/PVNxVamxtAM/s1600/newprojtfs.PNG\"><img style=\"display:block; margin:0px auto 10px; text-align:center;cursor:pointer; cursor:hand;width: 320px; height: 206px;\" src=\"http://1.bp.blogspot.com/-4goEc0y09kA/TwuVU2WQ1DI/AAAAAAAAAio/PVNxVamxtAM/s320/newprojtfs.PNG\" border=\"0\" alt=\"\"id=\"BLOGGER_PHOTO_ID_5695810339158938674\" /></a>" + 
        ...
        public const string content_15122011_r = "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2011/15122011_Server_Error.png\" alt=\"Server Error\" /></div>" + 
            ...
            "<p>And then it just works - no need for SQL Express, no additional configuration - just copied the files over to the host. Extremely positive experience.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_06122011_r = "<pre class=\"brush:xml\">" + 
            ...
            "<p>Reference:</p><a href=\"http://www.amazon.com/Bulletproof-Web-Design-flexibility-protecting/dp/0321808355\">Bulletproof Web Design: Improving flexibility and protecting against worst-case scenarios with HTML5 and CSS3 (3rd Edition)</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_27112011_r = "<p>A better idea may be to specify a special class that will handle validation (\"buddy class\" - funny name which seems to be an official term). I can add a partial declaration to the existing class which will not be wiped if the model changes, and in this declaration I will specify the class that handles validation. As long as the property names of the buddy class exactly match those of the actual class, I should be fine and the valiation will be handled for me by my model!</p><p>The code looks like that:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>The Metadata attribute specifies the buddy class, and the buddy class specifies validation requirements. The partial InBasket class is empty cause I don't want to add anything to the actual class functionality. The code builds (why wouldn't it? It's more important if it works), and I'll test it when I'm done with the views.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_26112011_r = "<ul><li>Avoid repetition. If I need to write a query, I will first check the repository - maybe it was already implemented</li><li>Encapsulation. Keep all data related code in the same place. Makes refactoring easier and separates logic from data</li><li>Unit testing. Tests can be written against the repository and, if necessary, in such way that the real database is not required</li></ul><p>For the purpose of my sample application, which I explain later, I will now add a repository for the \"In Basket\". It's extremely simple: each user can have multiple items in the basket. A user can view, edit and delete any of his items. So I need a small number of methods:</p><pre class=\"brush:csharp\">" + 
            ...
            "<p>It seems logical for the repository to exist in the Models folder.</p><p>And that's it for now - the next step is to create view(s) which will use the repository.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_14112011_r = "<p>First, a table have to be created to define the types in SQL Server and corresponding types in the language of choice - C# for me. The table is created by the following script:</p><pre class=\"brush:sql\">" +
            ...
            "<p>References</p><p><a href=\"http://stackoverflow.com/questions/2488383/how-can-i-programatically-convert-sql-data-types-to-net-data-types\">How can I programatically convert SQL data-types to .Net data-types?</a></p><p><a href=\"http://ysgitdiary.blogspot.com/2010/03/how-to-generate-classes-based-on-tables.html\">how-to generate classes based on tables in ms sql 2008</a></p><p><a href=\"https://plus.google.com/113035264903177615519/posts/N4qLkwQPmFE#113035264903177615519/posts/N4qLkwQPmFE\">Function to get the C# type based on the tsql type</a></p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_05112011_r = "<p>Let's assume that the user controls are in a separate project. So I create a new project using the \"WPF User Control Library\" template and call it WPFControlLibrary. Let's delete UserControl1.xaml so it doesn't get in the way. First I'll add references to the COM components I may need.</p><p>" +
            ...
            @"&lt;ResourceDictionary<br />    xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""<br />    xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""<br />    xmlns:local=""clr-namespace:WPFControlLibrary""&gt;<br />    &lt;Style TargetType=""{x:Type local:FlashControl}""&gt;<br />        &lt;Setter Property=""Template""&gt;<br />            &lt;Setter.Value&gt;<br />                &lt;ControlTemplate TargetType=""{x:Type local:FlashControl}""&gt;<br />                    &lt;Grid HorizontalAlignment=""Stretch"" VerticalAlignment=""Stretch""&gt;<br />                        &lt;ContentControl Content=""{TemplateBinding FlashPlayer}"" /&gt;<br />                    &lt;/Grid&gt;<br />                &lt;/ControlTemplate&gt;<br />            &lt;/Setter.Value&gt;<br />        &lt;/Setter&gt;<br />    &lt;/Style&gt;<br />&lt;/ResourceDictionary&gt;" + "</pre></p><p>And the hard part is over!</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_03112011_b = "<p>While writing the previous post, I had to find out how to show the special HTML characters, like <b>&amp;nbsp;</b></p><p>Because if I just type <b>&amp;nbsp;</b> I will only see the space. The browser will automatically convert the <b>&amp;nbsp;</b> to space, the <b>&amp;amp;</b> to an ampersand and so on. But I wanted to display exactly what I had in my XML.</p>";
        public const string content_03112011_r = "<p>So, to display <b>&amp;nbsp;</b> just as it is, I have to type <b>&amp;amp;nbsp;</b> in my post. <b>&amp;amp;</b> gets converted to ampersand and the <b>nbsp;</b> part is just displayed as it is.</p><p>What did I type to display <b>&amp;amp;nbsp;</b> in the line above? Well, <b>&amp;amp;amp;nbsp;</b> of course. I'd better stop here before I confuse myself and everyone else.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        //"Small Things Learned Today"
        public const string content_24102011_b = "<b><p>Drop a Default Constraint on a Table Before Dropping the Table.</p></b><p>Trying to drop the colum from a database via a simple script</p>";
        public const string content_24102011_r = "<p><pre class=\"brush:sql\">" + @"ALTER TABLE [dbo].MYTABLENAME DROP COLUMN MYCOLUMNNAME" + "</pre></p><p>I came across the error I did not quite expect.</p><p><pre class=\"brush:sql\">" + @"Msg 5074, Level 16, State 1, Line 1<br />The object 'DF__MYTABLENAME__MYCOL__42ACE4D4' is dependent on column 'MYCOLUMNNAME'.<br />Msg 4922, Level 16, State 9, Line 1<br />ALTER TABLE DROP COLUMN MYCOLUMNNAME failed because one or more objects access this column." + 
            ...
            @"declare @default sysname, @sql nvarchar(max)<br /><br />select @default = name <br />from sys.default_constraints <br />where parent_object_id = object_id('MYTABLENAME')<br />AND type = 'D'<br />AND parent_column_id = (<br /> select column_id <br /> from sys.columns <br /> where object_id = object_id('MYTABLENAME')<br /> and name = 'MYCOLUMNNAME'<br /> )<br /><br />set @sql = N'alter table MYTABLENAME drop constraint ' + @default<br />exec sp_executesql @sql<br /><br />alter table MYTABLENAME drop column MYCOLUMNNAME<br /><br />go" + "</pre></p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_13102011_r = "<p>I found the explanation and a sample implementation here:</p><p><a href=\"http://www.minddriven.de/index.php/technology/development/design-patterns/event-aggregator-implementation\">Simple message-based Event Aggregator</a></p><p>My prototype included two user controls, and I used the implementation of IEventAggregator and ISubscription from the link above.</p><p>That's the solution structure:</p><p>" +
            ...
            "</pre><p>I haven't given up on the Routed Events and Commands, that's my next subject to explore!</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_12102011_r = "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2011/12102011_The_Procedure_Entry_Point.png\" alt=\"The Procedure Entry Point\" /></div>" +
            ...
            "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2011/12102011_File_Not_Found_Exception.png\" alt=\"File Not Found Exception\" /></div><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_10102011_r = "<p><a href=\"http://thread.gmane.org/gmane.linux.kernel/1126136\">Subject: Re: Linux 2.6.39-rc3</a></p><p>I feel a bit sad because that's what I'm doing a lot recently - \"Oh, the API fails when I try to get visible image in JPG format? Well, how about infrared in BMP format? Oh, the API fails when I ask for a string? Well, I can live with a byte array, I'll do the conversion myself\".</p><p>That's a bad practice and I'm trying not to do that - my only excuse is the poor documentation supplied with third-party API's and SDK's.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_28062011_r = "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2011/28062011_Cryptic_Error_Message.png\" alt=\"Cryptic Error Message\" /></div>" + 
            "<p>All I needed was to tweak a setup and deployment project a little, so I made a copy from an existing one, added and removed some files, compiled without errors and tried to install.</p><p>Well, I had to work around it for now since there is really not enough information to even start investigating.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_10052010_r = "<pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>So what happens when the parameter does not belong to any of the types? It gets no value assigned, causing the exception. There is no \"default\" value. Easy to fix, but worth noting.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_24112009_r = "<pre class=\"brush:csharp\">" + @"private string GetLocalDatabasePath()<br />{<br /> string applicationPath = Path.GetDirectoryName(this.GetType().Assembly.GetName().CodeBase);<br /> string localDatabasePath = applicationPath + Path.DirectorySeparatorChar +<br />   ""TTrack.sdf"";<br /> return localDatabasePath;<br />}<br /><br />private string GetLocalConnectionString()<br />{<br /> string localConnectionString = ""Data Source="" +<br />   GetLocalDatabasePath();<br /><br /> return localConnectionString;<br />}" + 
            ...
            "<p>What happened there? Oh, of course - the NUnit test runs on the desktop, but the code is supposed to run on the emulator (I don't use the actual device yet). So, it looks like I will have to work on the approach to testing ...</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_01102009_r = "<p>However, that was not quite enough for me because the first tutorial's problem was that it explained the configuration file a bit, but did not implement the \"client\", and the second tutorial implemented both server and client, but had no info on configuration at all. So I quickly got to the point where I could have a server and client running inside separate windows services on the same machine, but as soon as I tried taking one of the services away - to another computer on the network - different errors started to happen. Not enough time and space on explaining each error and what was the reason for it, just a few words on what I ended up with (which eventually worked).</p><p>Service implementation</p><p>To define and implement the function on the server:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>Overall, it's just a few dozen lines of code, but it took me almost a whole day to get it working properly through the network.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_30072009_r = "</p>The command to generate the application template is</p><p><b>palm-generate -p \"{title:'My Application Title', id:com.mystuff.myapp, version:'1.0.0'}\" MyAppVersionOne</b></p><p>More on application structure here</p><p><a href=\"http://developer.palm.com/index.php?option=com_content&view=article&id=1626\">Application Structure</a></p><p>So, my first app has two <s>pages</s> scenes. On the first one I can press a button and this will insert a record in a database table. Another button will take me to the second scene. On the second scene the database table records are displayed and the button that takes me back to the first scene. Pretty basic stuff. The scene markup is as simple as that</p><p><a href=\"http://4.bp.blogspot.com/_Pk-5kPvf7Gs/SnGaqDeg6HI/AAAAAAAAAG4/BmpO50dDGq8/s1600-h/scene.PNG\"><img style=\"display:block; margin:0px auto 10px; text-align:center;cursor:pointer; cursor:hand;width: 320px; height: 82px;\" src=\"http://4.bp.blogspot.com/_Pk-5kPvf7Gs/SnGaqDeg6HI/AAAAAAAAAG4/BmpO50dDGq8/s320/scene.PNG\" border=\"0\" alt=\"\"id=\"BLOGGER_PHOTO_ID_5364238678453446770\" /></a></p><p>The add_button adds the record, the display_button takes me to the next scene. Other divs I use for debugging - they just display text. Now to the <s>code-behind</s> assistant.</p><pre class=\"brush:js\">" +
            ...
            "</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_19072009_r = "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2009/19072009_Chipdrive_SmartCard_Commander.png\" alt=\"Chipdrive SmartCard Commander\" /></div>" + 
            ...
            "</p><p>I only need to send the proper commands now...</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_15072009_r = "<p>So first of all I downloaded and installed NUnit framework</p><a href=\"http://www.nunit.org/index.php?p=download\">NUnit framework</a><p>Then I added a project of type class library to my solution and a single class called UnitTest to this solution. Here is the full code of the UnitTest class:</p><pre class=\"brush:csharp\">" + 
            ...
            "</p><p>What happened here? Took me some time to figure out ... the default printer was not set to my card printer.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_07072009_r = "<p><a href=\"http://www.datacard.com/id-card-printer-support-and-drivers/cp40-plus-card-printer\">Datacard CP40 Plus</a></p><p>Developing the application for the printer consists mostly of two parts - communicating with the printer and communicating with the smart card reader. You tell the printer to pick up the card, you tell the printer to position the card for smart card processing, you tell the smart card reader to write data to the smart card, you tell the printer to encode the magstripe and print something on the card, you tell the printer to finish with the print job.</p><p>It does not look so easy when you read the manual. This is how the programming flow looks like:</p>" +
            ...
            "<p>Now that was the easy part.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_09062009_r = "<p>If I want to get some values from the app.config file, I can keep them in the appSetting section and the whole app.config file for the small application can be as simple as that</p><pre class=\"brush:xml\">" + 
            ...
            "</pre><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_25052009_r = "<ul><br /><li>Select project(s) to be transferred from VSS database</li><br /><li>Back up project(s) and restore them to the new VSS database</li><br /><li>Fix the issues in the new VSS database with the Analyze tool</li><br /><li>Run the VSSConverter tool in analyse mode</li><br /><li>Get the TFS ready for migration</li><br /><li>Prepare the migration settings file</li><br /><li>Run the VSSConverter tool in migration mode</li><br /><li>Verify the results of the migration</li></ul><p>This may look rather lengthy and complex, but it makes sure that the current VSS database remains untouched, which is quite important for obvious reasons.</p><p>Here is how I migrated a small project from VSS to TFS in a few more detail:</p><p><h3>Select project(s) to be transferred from VSS database</h3></p><p>Let's say we want to transfer MySmallProject which is located in $/MyMiscProjects/MySmallProject in a large VSS database.</p><p><h3>Back up project(s) and restore them to the new VSS database</h3></p><p>Microsoft has two utilities for backing up and restoring VSS projects, SSARC and SSRESTOR. Their parameters are described in detail here:</p><p><a href=\"http://msdn.microsoft.com/en-us/library/t9d14fh1(VS.80).aspx\">SSARC</a><a href=\"http://msdn.microsoft.com/en-us/library/b4ch74ts(VS.80).aspx\">SSRESTOR</a></p><p>They usually can be found in the SourceSafe folder (i.e. C:\\Program Files\\Microsoft Visual SourceSafe)</p><p>First, I create a new VSS database (VSSTransfer) where I'm the admin. Next, I need to have admin rights in the initial VSS database and, of course, to know where it is located. Then I can run the SSARC command like that:</p><p><i><u>ssarc -d- -i -yadmin,password -s\\PathToVSSDB\\MyHugeVSSDB CodeProject.ssa \"$/MyMiscProjects/MySmallProject\"</u></i></p><p>This backs up the MySmallProject with default parameters, without deleting files from the old database \"MyHugeVSSDB\", into the CodeProject.ssa archive file.</p><p>Next, I restore the project into the new empty database I created.</p><p><i><u>ssrestor \"-p$/MySmallProject\" -sC:\\VSSTransfer -yadmin,password CodeProject.ssa \"$/MyMiscProjects/MySmallProject\"</u></i></p><p><h3>Fix the issues in the new VSS database with the Analyze tool</h3></p><p>This is just running the Analyze tool with the -F parameter to fix possible issues in the VSS.</p><p><h3>Run the VSSConverter tool in analyse mode</h3></p><p>The VSSConverter is a Microsoft tool that comes with the TFS and allows migrating data from VSS database into the TFS database. More info here:</p><p><a href=\"http://msdn.microsoft.com/en-us/library/ms253090(VS.80).aspx\">VSSConverter Command-Line Utility for Source Control Migration</a></p><p>To run the VSSConverter, a settings file has to be prepared first. Here is the sample:</p><pre class=\"brush:xml\"><?xml version=\"1.0\" encoding=\"utf-8\"?><br /><SourceControlConverter><br />      <ConverterSpecificSetting><br />            <Source name=\"VSS\"><br />                  <VSSDatabase name=\"C:\\VSSTransfer\"></VSSDatabase><br />            </Source><br />            <ProjectMap><br />            <Project Source=\"$/MySmallProject\"></Project><br />            </ProjectMap><br />      </ConverterSpecificSetting><br />      <Settings><br />       <Output file=\"Analysis.xml\"></Output><br />     </Settings><br /></SourceControlConverter></pre><p>(if we need to transfer multiple projects, there can be multiple 'Project' elements under 'ProjectMap')</p><p>Now I save the file as settings.xml and run the VSSConverter tool (which is located in drive:\\Program Files\\Microsoft Visual Studio 9.0\\Common7\\IDE ):</p><p><i><u>VSSConverter analyze settings.xml</u></i></p><p>(An important note, though - the VSSConverter should be the one that comes with TFS SP1. I tried to use the tool from the original TFS install and got troubles with history - it was not migrated at all).</p><p>Two files will be created, Analysis.xml and UserMap.xml</p><p><h3>Get the TFS ready for migration</h3></p><p>First of all, create the target project, i.e. MyTFSSmallProject. Then, look at the UserMap.xml. It lists all VSS users who performed action in the database. It looks like this:</p><pre class=\"brush:xml\"><?xml version=\"1.0\" encoding=\"utf-8\"?><br /><UserMappings xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"<br /> xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><br />  <UserMap From=\"Admin\" To=\"\" /><br />  <UserMap From=\"Bob\" To=\"\" /><br />  <UserMap From=\"Fred\" To=\"\" /><br />  <UserMap From=\"Jack\" To=\"\" /><br /></UserMappings></pre><p>To map users properly, we need to add them to TFS. If the user no longer exists, he can be mapped to any user - TFS admin or his team leader, for example. So the UserMap.xml will end up looking like this:</p><pre class=\"brush:xml\">" + 
            ...
            "</pre><p><h3>Run the VSSConverter tool in migration mode</h3></p><p>Run the VSSConverter tool in migration mode as follows:</p><p><i><u>VSSConverter Migrate migration_setting.xml</u></i></p><p>A report file called VSSMigrationReport.xml will be created if the migration process runs successfully. A log file called VSSConverter.log will contain information messages about the migration process.</p><p><h3>Verify the results of the migration</h3></p><p>Log in to TFS, go to the project's Source Control Explorer, check the files, history etc. Get the latest version, build it. Have fun.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_14042009_r = "<p>For the List type, for example, the following approach would work:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>The syntax could be a lot more elegant in 3.5, but this application uses the 2.0 framework.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_01042009_r = "<ul><li>I have not touched C++ in the last 8 years, so every little complaint from the linker or compiler was a challenge.</li><li>I could not find a complete solution for my case, so I had to compile a few together: learn how to write a dll in C++, learn how to write a wrapper class, learn how to call the wrapper class from the managed code etc.</li><li>There are numerous solutions on the internet, but choosing the right one is the problem. Some of the approaches I tried led me nowhere but took some time.</li></ul><p>Now, when I'm done with this bucket of excuses, here is how I solved my particular case:</p><p>First of all, I had to understand that the straightforward DllImport solution does not work. I came across a comment that suggested that when a class member has to be called from a dll, a managed wrapper dll has to be written to allow access to the class members. From the C++ sample code I had I could see that yes, a class member is called.</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>(To make the solution complete, I should also wrap the destructor and call it after I don't need the class any more, I'll do it soon)</p><p>Here we go, my longest post ever has arrived.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_15032009_r = "<p><a href=\"http://technet.microsoft.com/en-us/sysinternals/bb896653.aspx\">Process Explorer</a></p><p>Anyway, here is how the image was processed by the application:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>Now the image is saved properly and no handle is held against the file, so it is deleted properly too.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_23022009_r = "<p>There are a few valid reasons for that:<br />- The application comes together with a few other device driver packages<br />- Currently, these packages are bundled into the .msi package and installed on the client computer, and from there they have to be installed manually<br />- This brings the current .msi package size to over 100MB in size<br />- Not every client computer would use all of the device drivers<br />- If the application will need to support other hardware in the future, using the same approach will keep the .msi package bloating more and more.</p><p>So, the task was changed. The requirement now is to have an application in a separate package, and all the device drivers in separate packages, but the installation process will let users select which device drivers they want to install.</p><p>After some investigation I came to the conclusion that this can not be done using the Visual Studio Setup and Deployment project. The main limiting issue here is the fact that an .msi installer can not be started from withing another .msi installer. Therefore, I can not launch my application installer, show the dialog with options, and proceed to installing these optional drivers.</p><p>A simple solution I came up with was to write a small 'wrapper' Windows Forms application. The application would present the user with multiple checkboxes - one for each optional component.</p><p>After the user makes the choices and presses the 'Install' button, the application would first read the xml file which lists all available components</p><pre class=\"brush:xml\"><br /><?xml version='1.0'?><br /><setuppackages><br /> <package name=\"DriverPackage1\" path=\"\\DP1\\DriverPackage1.exe\"></package><br /> <package name=\"DriverPackage2\" path=\"\\DP2\\DriverPackage2.exe\"></package><br /> ...<br /> <package name=\"MainAppPackage\" path=\"\\App\\MainSetup.exe\"></package><br /></setuppackages><br /></pre><p>The name/path pairs would be added to the </p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>Other small details include a progress bar, success messages etc., but the main idea should be clear.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_16022009_r = "<p>Solution:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>Had to hardcode the 'SaveButton' name which I would really want to avoid, but did not want to spend more time on that.</p><p>Thoughts: this application could have been designed a little better to make future changes not so painful.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_11022009_r = "<pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>and that allowed me to get rid of a couple of dozens try/catch blocks in the application code without losing any exception handling functionality. Quite handy.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_10022009_r = "<p>I did the following:</p><p><li>Downloaded wiaaut.dll</li> <br /><li>Copied it to system32</li> <br /><li>Registered it with \"regsvr32 wiaaut.dll\" (successfully)</li><br /><li>Added a reference to wiaaut.dll to my project in Visual Studio.NET</li><br /><li>Checked that the Windows Image Acquisition (WIA) service is running</li></p><p>Next, I added and debugged the following code:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>However, the manager.DeviceInfos is always empty. I have 2 scanners attached, one of them shows in Control Panel->Scanners and Cameras, one doesn't, and both show under \"Imaging Devices\" in Device manager.</p><p>At this point, the only idea I have is that the scanner drivers just do not support WIA. As long as I have no way to check if this is true or not, I'll have to stick to the yesterday's solution.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_20012009_r = "<p>I spent some time updating my blog and posts to use the SyntaxHighlighter. I think it looks a little better now, so I'll keep it this way.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_16122008_r = "Now, go to Solution Explorer, right-click WindowsFormsApplication1 and select ‘add Class’. Class1 seems to be a good enough name. Hit OK.<br /><br />Now, make this class inherit from SoapHttpClientProtocol. For this purpose, add a reference to ‘System.Web.Services’ to References.<br /><br />Now, decorate this new Class1 with the WebServiceBindingAttribute.<br />You’ll end up with code as simple as this:<br /><pre class=\"brush:csharp\">" + 
            ...
            "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2008/16122008_WebServiceBindingAttribute.png\" alt=\"WebServiceBindingAttribute\" /></div>" + "<br /><br />This seems to be a bug in Visual Studio since it’s obvious that WebServiceBindingAttribute attribute is added to the class and the application will compile and execute regardless of the error screen. Seems to be safe to ignore. However, I did not find clarification on that yet.<br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_15122008_r = "<div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2008/10122008_3M_Document_Reader.png\" alt=\"3M Document Reader\" /></div><p>This smart device is supposed to be able to scan all sorts of passports and other identification documents and retrieve values like names, date of birth, document expiry dates and such. The documentation is not very straightforward and the code samples are in C++ only so it took me a bit of time to figure out how to operate this device programmatically.</p><p>First of all, a DocAuth.dll has to be referenced. (There is a bunch of development resources on the CD that comes with the device, and the dll’s are there too). After that, an object of a ReaderClass can be created.</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>If we’re lucky, the strings will contain proper name of the passport owner.</p><p>Now I can go and write a small application that can be used, for example, to add clients to a company database. It will scan the client’s passport and automatically populate fields like name, sex, DOB and a few others.</p><p>Overall, it's a fun device to work with. :-) </p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_13112008_r = "<pre class=\"brush:sql\">" + 
            ...
            "</pre><p>It looks a bit complex to understand, but does exactly what I need!</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_05112008_r = "<pre class=\"brush:sql\">" +
            ...
            @"dbo.fn_MyFunctionWithDefaultParameters(1, 2, 3, default, 5, 6)</pre><br/>" + "by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_28102008_r = "<p> And accepted, too. Looking forward to it. The company is huge, though it is not a software development or a consulting company. The development team is about 30 people and only develops software for company's internal needs. I start in 4 weeks.</p><p>Oh well, enough about it for now I guess.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_23102008_r = "<pre class=\"brush:csharp\">" + 
            ...
            @"CurrencyManager currencyManager1 = (CurrencyManager)<br />BindingContext[myDataGridView.DataSource];<br />currencyManager1.SuspendBinding();<br />foreach (DataGridViewRow row in myDataGridView.Rows)<br />{ <br />   if (someCondition) <br />   {<br />      row.Visible = false; <br />   }<br />}<br />myBindingSource.ResumeBinding();  // this is myDataGridView's binding source" + "</pre><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_20102008_r = "<pre class=\"brush:csharp\">" +
            ...
            "</pre><p>And it works like a charm!</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_14102008_r = "<br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_07102008_r = "<br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_06102008_r = "<pre class=\"brush:csharp\">" + @"MessageBox.Show(""Test"");" + "</pre><p>Or, you can type 'ctor', press Tab twice and the constructor for the class will be generated? </p><p>This can be customised. Have a look at the following file:</p><pre class=\"brush:csharp\">" + 
            ...
            "</pre><p>From here it's easy to understand how to make 'snippets' that do anything you want.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_04102008_r = "<p>Sometimes, however, you have a luxury of skipping this step. If a company is so huge or well-known that literally EVERYONE knows it, I think it's pretty safe to skip it.</p><p>I was at such company last week, maybe for the first time in my life. No, they didn't ask me 'so, what do you know about us?' :)</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_01102008_r = "<p>Great book. I won't try writing a review since there's plenty of them on the Internet. It's probably the most interesting book on managing software projects since</p><p><a href=\"http://www.amazon.com/Mythical-Man-Month-Software-Engineering-Anniversary/dp/0201835959/ref=sr_1_1?ie=UTF8&s=books&qid=1232267258&sr=1-1\">\"The Mythical Man-Month: Essays on Software Engineering\"</a></p><p>(I don''t read much on the subject anyway, so I could have missed a few dozens of good books).</p><p>Well after doing some reading, I learned a couple of things: my workspace is designed in the most counter-productive way possible and the project I am currently working on has all chances of joining those 25% of software products that are never actually used.</p><p style=\"color:#666666;\">Mood: insanely optimistic.</p><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_26112012_r = "<p>To use AJAX and update grid content, firstly the grid needs to be placed in the div which has an id. The <b>ajaxUpdateContainerId</b> has to be specified in the <b>WebGrid</b> declaration. To put it simple, in my main view I have a div</p><pre class=\"brush: xml\">" +
            ...
            "</pre><p>The result is then utilised by the <b>ShowDialog</b> function, that displays a <b>jQuery</b> dialog. When the user closes the dialog, the page is refreshed so that the <b>WebGrid</b> contents are updated with the latest data retrieved.</p><div class=\"separator\" style=\"clear: both; text-align: center;\"><img src=\"../../../Content/images/blog/pr/2012/26112012_Complete_Example.png\" alt=\"Complete WebGrid Example\" /></div><p align=\"center\">Complete example</p><p><b>References</b></p><a href=\"http://msdn.microsoft.com/en-us/magazine/hh288075.aspx\">Get the Most out of WebGrid in ASP.NET MVC</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
        ...
        public const string content_25112012_r = "<p>Next I added server paging. Why wouldn't I use the built-in paging? Well, the database table behind WebGrid may have hundreds of records. I wouldn't want to pass it all to my <b>ViewModel</b> and then to the view just to display 5 or 10 of the records I actually need. It is handy that the WebGrid paging is in the form of <b>http://website/Items/ShowAll?page=3</b>. This way my controller knows which page is to be displayed and can preselect the data just for this page only.</p><p>To implement paging, I added the TotalRows to the model - that will specify the total number of records in the database table.</p><p>The controller method now looks as follows:</p><pre class=\"brush: csharp\">" +
            ...
            "</pre><p><b>References</b></p><a href=\"http://msdn.microsoft.com/en-us/magazine/hh288075.aspx\">Get the Most out of WebGrid in ASP.NET MVC</a><br/>by <a title=\"Evgeny\" rel=\"author\" href=\"https://plus.google.com/112677661119561622427?rel=author\" alt=\"Google+\" title=\"Google+\">Evgeny</a>";
